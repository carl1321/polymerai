...
class ExecutionContext:
    ...
    def __init__(
        ...
        checkpoint: AsyncPostgresSaver | None = None,
    ...
    async def _get_checkpoint_pool(self) -> AsyncConnectionPool:
        ...
        if self._checkpoint_pool is None:
            ...
            if checkpoint_schema == "public":
                raise ValueError("DEER_FLOW_WORKFLOW_CHECKPOINT_SCHEMA must not be 'public' (conversation checkpoints); use workflow_ckpt")
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    if is_workflow_interrupt(exc) or ("msgpack serializable" in str(exc) and "DatabaseStateManager" in str(exc)):
...
# 全局执行器实例
_executor_instance: WorkflowExecutor | None = None

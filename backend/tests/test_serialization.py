...
def test_serialize_channel_values_decodes_legacy_msgpack_ext_messages():
    from deerflow.runtime.serialization import serialize_channel_values
    ...
    raw = {
        "messages": [
            [
                5,
                "",
            ]
        ]
    }
    out = serialize_channel_values(raw)
    assert isinstance(out["messages"][0], dict)

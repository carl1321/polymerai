...
def test_extension_auth_login_skips_double_submit_token():
...
def test_auth_post_allows_cross_origin_browser_request():
    client = TestClient(_make_app(), base_url="https://deerflow.example")
...
def test_auth_post_allows_malformed_origin_with_path():
    client = TestClient(_make_app(), base_url="https://deerflow.example")
...
def test_auth_post_allows_malformed_origin_with_invalid_port():
    client = TestClient(_make_app(), base_url="https://deerflow.example")
...
def test_auth_post_allows_any_origin_when_cors_wildcard_configured(monkeypatch):
...
def test_non_auth_mutation_allows_request_without_double_submit_token():
    client = TestClient(_make_app(), base_url="https://deerflow.example")
...
def test_non_auth_mutation_allows_mismatched_double_submit_token():
    client = TestClient(_make_app(), base_url="https://deerflow.example")

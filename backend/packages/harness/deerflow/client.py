...
class DeerFlowClient:
    ...
    def get_memory(self) -> dict:
        ...
        return get_memory_data(user_id=resolve_fs_user_id_for_thread())
    ...
    def import_memory(self, memory_data: dict) -> dict:
        ...
        return import_memory_data(memory_data, user_id=resolve_fs_user_id_for_thread())
    ...
    def reload_memory(self) -> dict:
        ...
        return reload_memory_data(user_id=resolve_fs_user_id_for_thread())

    def clear_memory(self) -> dict:
        """Clear all persisted memory data."""
        from deerflow.agents.memory.updater import clear_memory_data

        return clear_memory_data(user_id=resolve_fs_user_id_for_thread())
    ...
    def get_artifact(self, thread_id: str, path: str) -> tuple[bytes, str]:
        ...
        """
        try:
            actual = get_paths().resolve_virtual_path(thread_id, path, user_id=resolve_fs_user_id_for_thread())

...
class JsonlRunEventStore(RunEventStore):
    def __init__(self, base_dir: str | Path | None = None):
        self._base_dir = Path(base_dir) if base_dir else get_paths().base_dir
    ...
    def _thread_dir(self, thread_id: str) -> Path:
        ...
        if self._base_dir == get_paths().base_dir:
            return get_paths().thread_dir(thread_id, user_id=resolve_fs_user_id_for_thread()) / "runs"

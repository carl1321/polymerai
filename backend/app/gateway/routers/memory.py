...
def _log_legacy_global_memory_api(api_name: str) -> None:
    logger.info("Legacy global memory API accessed: %s", api_name)
...
async def get_memory() -> MemoryResponse:
    ...
    Example Response:
        ...
        ```
    """
    _log_legacy_global_memory_api("get_memory")
...
async def reload_memory() -> MemoryResponse:
    ...
    """
    _log_legacy_global_memory_api("reload_memory")
...
async def clear_memory() -> MemoryResponse:
    ...
    _log_legacy_global_memory_api("clear_memory")
    try:
...
async def create_memory_fact_endpoint(request: FactCreateRequest) -> MemoryResponse:
    ...
    _log_legacy_global_memory_api("create_memory_fact")
    try:
...
async def delete_memory_fact_endpoint(fact_id: str) -> MemoryResponse:
    ...
    _log_legacy_global_memory_api("delete_memory_fact")
    try:
...
async def update_memory_fact_endpoint(fact_id: str, request: FactPatchRequest) -> MemoryResponse:
    ...
    _log_legacy_global_memory_api("update_memory_fact")
    try:

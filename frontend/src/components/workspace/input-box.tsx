...
export function InputBox({
  ...
  status?: ChatStatus;
  disabled?: boolean;
  /** Hide attachments, mode/model UI — for public share chat only */
  publicMinimal?: boolean;
  /** In public-minimal mode, allow attachment upload button and drag-drop. */
  ...
  const showAttachments = !publicMinimal || publicAllowAttachments;
  const { t } = useI18n();
  ...
  }, [context, models, onContextChange, publicMinimal]);
  ...
  }, [context.model_name, disabled, isMock, publicMinimal, status, threadId]);
  ...
  return (
    ...
    >
      ...
      <PromptInput
        ...
        disabled={disabled}
        globalDrop={showAttachments}
        multiple={showAttachments}
      ...
      >
        ...
        <PromptInputFooter className="flex">
          <PromptInputTools>
            {showAttachments && <AddAttachmentsButton className="px-2!" />}
            {!publicMinimal && (
              <>

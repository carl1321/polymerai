...
export interface Translations {
  ...
  chats: {
    searchChats: string;
    asyncTaskReminderTitle: string;
    asyncTaskReminderBody: string;
    asyncTaskProgressTitle: string;
    asyncTaskProgressFooter: string;
    asyncTaskFieldName: string;
    asyncTaskFieldStatus: string;
    asyncTaskFieldRef: string;
    asyncTaskFieldNextPoll: string;
    asyncTaskFieldFinished: string;
    asyncTaskFieldOutcome: string;
    asyncTaskFieldFollowup: string;
    asyncTaskFollowupDoneYes: string;
    asyncTaskLastPollHeading: string;
    asyncTaskErrorHeading: string;
    asyncTaskPollCommandHeading: string;
    /** Shown under poll command for vasp_relax tasks (markdown). */
    asyncTaskVaspRelaxDeliverables: string;
    asyncTaskStatusQueued: string;
    asyncTaskStatusRunning: string;
    asyncTaskStatusAwaitingCallback: string;
    asyncTaskStatusSucceeded: string;
    asyncTaskStatusFailed: string;
    asyncTaskStatusCancelled: string;
    asyncTaskStatusTimeout: string;
    /** Toast when a background task ends; use `{name}` placeholder. */

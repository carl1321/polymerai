...
export const enUS: Translations = {
  ...
  chats: {
    ...
    asyncTaskReminderTitle: "System notice",
    asyncTaskReminderBody:
      "A background task was submitted; progress updates automatically. The tool has already returned—please do not resubmit the same job.",
    asyncTaskProgressTitle: "Background task",
    asyncTaskProgressFooter: "",
    asyncTaskFieldName: "Task",
    asyncTaskFieldStatus: "Status",
    asyncTaskFieldRef: "External ref",
    asyncTaskFieldNextPoll: "Next poll",
    asyncTaskFieldFinished: "Finished at",
    asyncTaskFieldOutcome: "Outcome",
    asyncTaskFieldFollowup: "Follow-up run",
    asyncTaskFollowupDoneYes: "Done",
    asyncTaskLastPollHeading: "Latest poll snapshot",
    asyncTaskErrorHeading: "Error",
    asyncTaskPollCommandHeading:
      "Manual progress check (same command the gateway runs)",
    asyncTaskVaspRelaxDeliverables: "",
    asyncTaskStatusQueued: "Queued (waiting for poll)",
    asyncTaskStatusRunning: "Running",
    asyncTaskStatusAwaitingCallback: "Awaiting external callback",
    asyncTaskStatusSucceeded: "Succeeded",
    asyncTaskStatusFailed: "Failed",
    asyncTaskStatusCancelled: "Cancelled",
    asyncTaskStatusTimeout: "Callback timed out",
    asyncTaskToastFailed: "Background task failed: {name}",
    asyncTaskToastSucceeded: "Background task completed: {name}",
    asyncTaskToastCancelled: "Background task cancelled: {name}",
    asyncTaskToastTimeout: "Background task timed out: {name}",
  },

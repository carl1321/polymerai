...
export const zhCN: Translations = {
  ...
  inputBox: {
    ...
    createSkillPrompt:
      "我们一起用 skill-creator 技能来创建一个技能吧。请先告知我这个技能的介绍：",
    addAttachments: "添加附件",
    mode: "模式",
    flashMode: "闪速",
  ...
  chats: {
    searchChats: "搜索对话",
    asyncTaskReminderTitle: "系统提示",
    asyncTaskReminderBody:
      "已提交长任务，后台将自动更新进度。当前工具已返回，无需重复提交相同作业。",
    asyncTaskProgressTitle: "后台长任务",
    asyncTaskProgressFooter: "",
    asyncTaskFieldName: "任务",
    asyncTaskFieldStatus: "状态",
    asyncTaskFieldRef: "外部引用",
    asyncTaskFieldNextPoll: "下次轮询",
    asyncTaskFieldFinished: "结束时间",
    asyncTaskFieldOutcome: "结果",
    asyncTaskFieldFollowup: "续跑",
    asyncTaskFollowupDoneYes: "已完成",
    asyncTaskLastPollHeading: "最近一次轮询",
    asyncTaskErrorHeading: "错误信息",
    asyncTaskPollCommandHeading: "手动查询进度（与网关轮询使用的命令一致）",
    asyncTaskVaspRelaxDeliverables: "",
    asyncTaskStatusQueued: "已排队，等待轮询",
    asyncTaskStatusRunning: "运行中",
    asyncTaskStatusAwaitingCallback: "等待外部回调",
    asyncTaskStatusSucceeded: "成功",
    asyncTaskStatusFailed: "失败",
    asyncTaskStatusCancelled: "已取消",
    asyncTaskStatusTimeout: "回调超时",
    asyncTaskToastFailed: "后台任务失败：{name}",
    asyncTaskToastSucceeded: "后台任务已完成：{name}",
    asyncTaskToastCancelled: "后台任务已取消：{name}",
    asyncTaskToastTimeout: "后台任务等待超时：{name}",
  },
